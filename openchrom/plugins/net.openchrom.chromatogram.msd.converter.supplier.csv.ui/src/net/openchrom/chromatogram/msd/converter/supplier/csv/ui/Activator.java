 ...
 * All rights reserved.
 *******************************************************************************/
package net.openchrom.chromatogram.msd.converter.supplier.csv.ui;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "net.openchrom.chromatogram.msd.converter.supplier.csv.ui"; //$NON-NLS-1$
	// The shared instance
