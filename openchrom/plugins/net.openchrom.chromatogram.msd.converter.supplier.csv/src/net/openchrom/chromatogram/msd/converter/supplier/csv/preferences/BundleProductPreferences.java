...
public class BundleProductPreferences {
	 ...
	 * the same product id (converter csv index.php $pluginIdentifier).
	...
	public static final String CONVERTER_ID = "net.openchrom.chromatogram.msd.converter.supplier.csv";
	/*
	...
	public static IProductPreferences getProductPreferences() {
		 ...
		 */
		Preferences preferences = new InstanceScope().getNode("net.openchrom.chromatogram.msd.converter.supplier.csv.ui");
